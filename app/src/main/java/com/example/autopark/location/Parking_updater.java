...
public class Parking_updater extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private DB_ParkingUpdater db_parkingUpdater;
    @Override
...
//                        if (location != null) {
//                            Log.d("a","last location"+location);
...
//                });
    ...
    protected void onResume() {
        ...
        if (!checkPlayServices()) {
            ...
            Log.d("updater","You need to install Google Play Services to use the App properly");
        }
    }
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (location != null) {
            ...
            LastKnownLocation = location;
            Log.d("updater","on connected Latitude : " + location.getLatitude() + "\nLongitude : " + location.getLongitude());
        }
    ...
    public void onLocationChanged(Location location) {
        if (location != null) {
            ...
            Log.d("updater","on location changed Latitude : " + location.getLatitude() + "\nLongitude : " + location.getLongitude());
        }
    }
                ...
                if (permissionsRejected.size() > 0) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (shouldShowRequestPermissionRationale(permissionsRejected.get(0))) {
                            new AlertDialog.Builder(Parking_updater.this).
