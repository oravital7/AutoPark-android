...
public class RegistrationActivity extends AppCompatActivity {
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                updateAdditionalInformation(auth.getCurrentUser());
                            } else {
    ...
    private void updateAdditionalInformation(FirebaseUser currentUser) {
    ...
    private boolean isValidData(User user) {
        ...
        user.setFirstName(firstName.getText().toString()).setLastName(lastName.getText().toString())
                .setEmail(email.getText().toString()).setCountry(country.getText().toString())
                .setCity(city.getText().toString()).setStreet(street.getText().toString())
                .setHouseNumber(houseNumber.getText().toString()).setPhoneNumber(phoneNumber.getText().toString());
